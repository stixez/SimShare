    ...
    <div className="grid grid-cols-2 gap-4">
      <div className="bg-bg-card rounded-xl border border-border p-5">
        ...
        <p className="text-xs text-txt-dim leading-relaxed">
          If you and your friends are on the same Wi-Fi or LAN, SimShare will automatically discover
      ...
      <div className="bg-bg-card rounded-xl border border-border p-5">
        ...
        <p className="text-xs text-txt-dim leading-relaxed">
          ...
          (free). It creates a virtual LAN between your devices so SimShare works as if you were on
          the same network.
        </p>
      </div>
    </div>
