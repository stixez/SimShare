...
export default function DonateModal() {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50" onClick={() => setShowDonate(false)} role="dialog" aria-modal="true" aria-label="Support SyncCrate">
      <div className="bg-bg-card rounded-2xl border border-border p-6 max-w-sm w-full mx-4" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-bold text-lg">Support SyncCrate</h3>
          </div>
          <button
