import { LayoutDashboard, Package, Save, FolderOpen, Activity, Wifi, WifiOff } from "lucide-react";
  ...
  return (
    <aside className="w-[180px] h-screen bg-bg-card border-r border-border flex flex-col shrink-0">
      <div className="p-4 border-b border-border">
        <h1 className="text-lg font-bold text-accent-light tracking-tight">SimSync</h1>
        <p className="text-[10px] text-txt-dim mt-0.5">v0.1.0 • Community Edition</p>
      </div>
